...
<div class="navbar-inner text-center">
    <p>
        ...
        <a href="<?php echo BASE_URL?>subcategoria/nuevo" class="btn btn-primary">Nuevo</a>
    </p>
    <div id="grilla">
    <table id="table" class="table table-striped table-bordered table-hover sortable">
        ...
        <?php for ($i = 0; $i < count($this->datos); $i++) { ?>
            <tr>
                ...
                <td><?php echo $this->datos[$i]['CCATEGORIA'] ?></td>
                <td>
                    <a href="javascript:void(0)" onclick="editar('<?php echo BASE_URL?>subcategoria/editar/<?php echo $this->datos[$i]['ID_SUBCATEGORIA'] ?>')" class="btn btn-success"><i class="icon-pencil icon-white"></i> Editar</a>
                    <a href="javascript:void(0)" onclick="eliminar('<?php echo BASE_URL?>subcategoria/eliminar/<?php echo $this->datos[$i]['ID_SUBCATEGORIA'] ?>')" class="btn btn-danger"><i class="icon-remove icon-white"></i> Eliminar</a>
                </td>
            </tr>
        <?php } ?>
        </tbody>
