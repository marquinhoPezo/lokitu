...
<div class="navbar-inner">
        ...
        <table align="center" cellpadding="5" width="100%">
            <tr>
                <td colspan="2">
                    <div class="row-fluid text-right">
                        <div class="span12">
                            Nro. Doc.:
                            <input type="text" id="nrodoc" name="nrodoc" class="input-small" style="margin-right: 1em" readonly="readonly"/>
                        </div>
                    </div>
                </td>
            </tr>
                ...
                <td colspan="2">
                    <div class="row-fluid">
                        <div class="span12 text-left">
                            ...
                            <input type="text" name="cliente" id="cliente" readonly="readonly" data-toggle="modal" data-target="#modalCliente"/>
                            <button style="margin-top:-10px" data-toggle="modal" data-target="#modalCliente" type="button" class="btn btn-primary" title="Buscar Cliente" id="AbrirVtnBuscarCliente"><i class="icon-search icon-white"></i></button>
                            <button style="margin: -10px 10px 0 0" data-toggle="modal" data-target="#modalNuevoCliente" type="button" class="btn btn-primary" title="Insertar Cliente"><i class="icon-plus icon-white"></i></button>
                            Tipo Comprobante:
            ...
            <tr style="border-top: solid 1px #999">
                <td>
                    ...
                    <button type="button" style="margin-top: -10px" class="btn btn-primary" title="Buscar Producto" id="AbrirVtnBuscarProducto"><i class="icon-search icon-white"></i></button>
                    ...
                    <input type="hidden" name="idub" id="idub" />
                    <input type="hidden" name="cantidadub" id="cantidadub" placeholder="Cantidad UB"/>
                    <input type="hidden" name="precioub" id="precioub" />
                    <input type="text" name="preciounitario" id="preciounitario" placeholder="PUxUM" class="input-small" readonly="readonly"/>  
    ...
    <!-- Modal -->
    <style>
        #modalCliente,#modalProducto,#modalNuevoCliente{
            width: 800px;
            left: 38%;
        }
    </style>
    ...
    <div id="modalNuevoCliente" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
