    ...
    <div class="row-fluid">
        <div>
            ...
            <option value="2">Empleado</option>
                ...
                <a href="<?php echo BASE_URL ?>venta/nuevo" class="btn btn-grey"><i class="icon-plus icon-white"></i> Nuevo</a>
            </div>
            <br/>
        </div>
    </div>
            ...
            <tbody>
                <?php for ($i = 0; $i < count($this->datos); $i++) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="#myModal" role="button" data-toggle="modal" onclick="ver('<?php echo $this->datos[$i]['ID_VENTA'] ?>')" class="btn btn-warning btn-minier"><i class="icon-eye-open icon-white"></i> Ver</a>
                            <?php if($this->datos[$i]['ESTADOPAGO'] == 0) {  ?>
                            <a href="javascript:void(0)" onclick="eliminar('<?php echo BASE_URL ?>venta/eliminar/<?php echo $this->datos[$i]['ID_VENTA'] ?>')" class="btn btn-danger btn-minier"><i class="icon-remove icon-white"></i> Eliminar</a>
                            <?php } ?>
                        </td>
                    </tr>
                <?php } ?>
