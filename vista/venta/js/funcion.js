        ...
        function buscar(){
            $.post(url+'venta/buscador','descripcion='+$("#buscar").val()+'&filtro='+$("#filtro").val(),function(datos){
                ...
                for(var i=0;i<datos.length;i++){
                    ...
                    HTML = HTML + '<td>';
                    HTML = HTML + '<a href="#myModal" style="margin-right:4px" role="button" data-toggle="modal" onclick="ver(\''+datos[i].ID_VENTA+'\')" class="btn btn-warning btn-minier"><i class="icon-eye-open icon-white"></i> Ver</a>';
