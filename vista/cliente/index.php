    ...
    <div class="row-fluid">
        <div>
            ...
            <option value="1">DNI / RUC</option>
                ...
                <a href="<?php echo BASE_URL ?>cliente/nuevo" class="btn btn-grey"><i class="icon-plus icon-white"></i> Nuevo</a>
            </div>
            <br/>
        </div>
    </div>
...
<?php for ($i = 0; $i < count($this->datos); $i++) { ?>
            <tr>
                ...
                <td>
                    <a href="#myModal" role="button" data-toggle="modal" onclick="ver('<?php echo $this->datos[$i]['IDCLIENTE'] ?>')" class="btn btn-warning btn-minier"><i class="icon-eye-open icon-white"></i> Ver</a>
                    <a href="javascript:void(0)" onclick="editar('<?php echo BASE_URL?>cliente/editar/<?php echo $this->datos[$i]['IDCLIENTE'] ?>')" class="btn btn-success btn-minier"><i class="icon-pencil icon-white"></i> Editar</a>
                </td>
            </tr>
        <?php } ?>
        </tbody>
