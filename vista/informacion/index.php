...
<?php if (isset($this->datos) && count($this->datos)) { ?>
    <br/>
    <a href="<?php echo BASE_URL?>informacion/editar" class="btn btn-grey">Editar</a>
    <div class="row-fluid">
        <div class="span3">
            Quienes Somos<br>
        ...
        <div class="span3">
            Reseña Histórica<br>
            <a href="#myModal" role="button" data-toggle="modal" onclick="ver('4')" class="btn btn-success">Ver Información</a>
        </div>
    </div>
    <br/>
<?php } ?>
