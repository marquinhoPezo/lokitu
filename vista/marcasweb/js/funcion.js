...
$(function(){
    ...
    function buscar(){
            var HTML='',HTML2='';
            $.post(url+'marcasweb/buscar','cadena='+$("#buscar").val()+'&filtro='+$("#filtro").val(),function(datos){
                ...
                for(var i=0;i<datos.length;i++){
                    ...
                    var editar=url+'marcasweb/editar/'+datos[i].ID; 
                    var eliminar=url+'marcasweb/eliminar/'+datos[i].ID;   
...
function ver(id){
            ...
            html='';titulo='';
           $.post(url+'marcasweb/ver','id='+id,function(datos){
