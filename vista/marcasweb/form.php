    ...
    <table align="center" cellpadding="10">
        ...
        <tr>
            ...
            <div id="imagen_subida" style="text-align: center">
                <img width="160px" height="100px" src="<?php echo BASE_URL ?>lib/img/marcas/<?php echo strtolower($this->datos[0]['IMAGEN']) ?>" />
                <br><br>
        ...
        <tr>
            <td colspan="2" align="center">
                ...
                <a href="<?php echo BASE_URL ?>marcasweb" class="btn btn-info">Cancelar</a></p>
            </td>
        </tr>
    </table>
</form>
