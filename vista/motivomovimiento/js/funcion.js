...
$(function(){
        ...
        function buscar(){
            $.post(url+'motivomovimiento/buscador','descripcion='+$("#buscar").val()+'&filtro='+$("#filtro").val(),function(datos){
                ...
                for(var i=0;i<datos.length;i++){
                    ...
                    var editar=url+'motivomovimiento/editar/'+datos[i].ID_MOTIVOMOVIMIENTO; 
                    var eliminar=url+'motivomovimiento/eliminar/'+datos[i].ID_MOTIVOMOVIMIENTO;   
