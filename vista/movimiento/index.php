    ...
    <div class="row-fluid">
        <div>
            ...
            <option value="0">Concepto</option>
                ...
                <a href="<?php echo BASE_URL ?>movimiento/nuevo" class="btn btn-grey"><i class="icon-plus icon-white"></i> Nuevo</a>
            </div>
            <br/>
        </div>
    </div>
                ...
                <tbody>
                    <?php for ($i = 0; $i < count($this->datos); $i++) { ?>
                        <tr>
                            ...
                            <td><?php echo $this->datos[$i]['FFORMAPAGO'] ?></td>
                            <td><?php echo $this->datos[$i]['MONTO'] ?></td>
                            <td>
                                <a href="<?php echo BASE_URL?>movimiento/extornar/<?php echo $this->datos[$i]['ID_MOVIMIENTO'] ?>" class="btn btn-info btn-minier"><i class="icon-repeat icon-white"></i> Extornar</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
