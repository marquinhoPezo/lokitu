...
//            echo '<pre>';print_r($_POST);exit;
            ...
            $this->_venta->id_almacen = $_POST['id_almacen'];
...
//            print_r($dato_venta);exit;
            ...
            for($i=0;$i<count($_POST['id_producto']);$i++){
                ...
                $this->_detventa->id_producto= $_POST['id_producto'][$i];
                $this->_detventa->cantidadum= $_POST['cantidadum'][$i];
                $this->_detventa->preciounitario= $_POST['preciounitario'][$i];
                $this->_detventa->id_unidadmedida= $_POST['id_unidadmedida'][$i];
                $this->_detventa->cantidadub= $_POST['cantidadub'][$i];
                $this->_detventa->precioub= $_POST['precioub'][$i];
...
//            echo '<pre>';print_r($datos);exit;
        ...
        $this->_almacenes->id_sucursal = session::get('idsucursal');
