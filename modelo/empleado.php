...
class empleado extends Main{
    ...
    public function selecciona() {
        ...
        $datos = array($this->id_empleado, $this->nombre, $this->apellido,$this->usuario, $this->perfil, $this->sucursal);
//        echo '<pre>';print_r($datos);exit;
    ...
    public function inserta() {
        $datos = array($this->nombre, $this->apellido, $this->direccion, $this->telefono, $this->dni, $this->fechanacimiento, 
            $this->usuario, $this->clave, $this->id_perfil, $this->id_sucursal);
    ...
    public function actualiza() {
        $datos = array($this->id_empleado, $this->nombre, $this->apellido, $this->direccion, $this->telefono, $this->dni, 
            $this->fechanacimiento, $this->usuario, $this->clave, $this->id_perfil, $this->id_sucursal);
