...
class caja extends Main{
    ...
    public function selecciona() {
        ...
        $datos = array($this->idcaja, $this->empleado, $this->id_sucursal);
    ...
    public function inserta() {
        $this->id_sucursal=session::get('idsucursal');
        $datos = array(0, $this->idempleado, $this->fecha_ap, $this->estado, $this->id_sucursal);
//        print_r($datos);exit;
    ...
    public function actualiza() {
        ...
        if(is_null($this->saldo)){
            $datos = array(1, $this->idempleado, $this->fecha_ci, $this->estado, $this->id_sucursal);
//            print_r($datos);exit;
            $r = $this->get_consulta("insact_caja", $datos);
        }else{
