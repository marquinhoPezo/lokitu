...
class seriecomprobante extends Main{
    ...
    public function selecciona() {
        ...
        $datos = array($this->id_seriecomprobante, $this->tipocomprobante, $this->id_tipocomprobante, $this->id_sucursal);
//        print_r($datos);exit;
    ...
    public function inserta() {
        $datos = array($this->serie, $this->id_tipocomprobante, $this->maxcorrelativo, $this->id_sucursal);
    ...
    public function actualiza() {
        $datos = array($this->id_seriecomprobante, $this->serie, $this->id_tipocomprobante, 
            $this->maxcorrelativo, $this->id_sucursal);
